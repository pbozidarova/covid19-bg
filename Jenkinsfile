    ...
    stage('Logging into AWS ECR') {
      steps {
        sh '''
          ...
          docker tag covid19explorebulgarianstatistics-build_client:latest 159792149734.dkr.ecr.us-east-1.amazonaws.com/covid19databulgaria-docker_client:latest
